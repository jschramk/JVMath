...
public class RewriteResources {
  ...
  static {
    ...
    try {
      ...
      InputStream simplify = RewriteResources.class.getResourceAsStream("simplify_processed.json");
      InputStream solve = RewriteResources.class.getResourceAsStream("solve_processed.json");
