...
public class Knowns_Old {
  ...
  public static boolean sameVariables(Knowns_Old k1, Knowns_Old k2) {
  ...
  public static Knowns_Old combine(Knowns_Old k1, Knowns_Old k2) {
    Knowns_Old result = new Knowns_Old();
