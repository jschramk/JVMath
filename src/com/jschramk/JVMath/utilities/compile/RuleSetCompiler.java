...
public class RuleSetCompiler {
    ...
    private static class CodeRule {
        ...
        @Override public String toString() {
            return "Definition{" + "id='" + id + '\'' + ", action='" + action + '\'' + ", find='"
    ...
    public static void convertJsonToCode(File input, File output)
        ...
        for (int i = 0; i < array.size(); i++) {
            ...
            String s = Rule.toRuleDefinition(array.get(i).getAsJsonObject(), p);
                ...
                if (req.matches("is[ \\t]+f\\(.*?\\)")) {
                    ...
                    if (m.find()) {
                        ...
                        if (targetVariable.equals("#target")) {
                            ...
                            System.out.println(
                                "WARNING: f(" + targetVariable + ") is not supported currently");
